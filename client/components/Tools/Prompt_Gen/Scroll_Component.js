        ...
        return (
            <div className="gen-scroll">
                <div className="gen-btns">
                    ...
                    <div onClick={() => this.genPlotPoint()}><img src="assets/tools/prompt_gen/gen_pp_btn.png" className="gen-btn" /></div>
                    <div onClick={() => this.regenLast()}><img src="assets/tools/prompt_gen/gen_regen_btn.png" className="gen-btn" /></div>
                </div>
                {(this.state.text) ?
                    <div>
